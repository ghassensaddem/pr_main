...
<body class="">
  <div class="wrapper ">
              ...
              <table class="table">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="text-center">panier_id</th>
                    <th>nom</th>
                    <th>prix</th>
                    <th>ptix_t</th>
    ...
    ?>
                  <tr>
                    <td class="text-center"><?= $panier['panier_id']; ?></td>
                    <td><?= $panier['nom']; ?></td>
                    <td><?= $panier['prix']; ?></td>
                    <td><?= $panier['prix_t']; ?></td>
                    <td class="td-actions text-right">
                      <form method="POST" action="../view/updatepanier.php">
                        <button class="btn btn-success btn-sm  btn-icon" type="submit" name="update" value="Update">
                        <i class="now-ui-icons ui-2_settings-90"></i>
                        </button>
                        <input type="hidden" value=<?PHP echo $panier['panier_id']; ?> panier="panier_id">
                      </form>
                      <a class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" 
                      href="../view/deletepanier.php?panier_id=<?php echo $panier['panier_id']; ?>"> 
                      <button  class="btn btn-danger btn-sm  btn-icon">
                          <i class="now-ui-icons ui-1_simple-remove"></i>
                        </button>
                    </a>
                      
                      <a href="../view/addpanier.php">
